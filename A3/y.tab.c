...
#line 259 "syntax_analyzer.y"
    {
		...
		(yyval) = new symbol_info("for_statement", "non_terminal", node);
...
#line 299 "syntax_analyzer.y"
    {
		...
		node->addChild(TreeNode::createTerminalNode("RPAREN", ")"));
		node->addChild((yyvsp[(5) - (5)])->getNode());
		(yyval) = new symbol_info("while_statement", "non_terminal", node);
...
#line 359 "syntax_analyzer.y"
    {
		...
		node->addChild((yyvsp[(3) - (4)])->getNode());
		node->addChild(TreeNode::createTerminalNode("RTHIRD", "]"));
		(yyval) = new symbol_info("array", "non_terminal", node);
...
#line 377 "syntax_analyzer.y"
    {
		...
		node->addChild((yyvsp[(3) - (3)])->getNode());
		(yyval) = new symbol_info("assign_expression", "non_terminal", node);
...
#line 481 "syntax_analyzer.y"
    {
		...
		node->addChild((yyvsp[(3) - (4)])->getNode());
		node->addChild(TreeNode::createTerminalNode("RPAREN", ")"));
		(yyval) = new symbol_info("func_call", "non_terminal", node);
